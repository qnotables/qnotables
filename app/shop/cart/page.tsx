        ...
        {items.length > 0 && (
          <div className="space-y-4 lg:h-fit lg:sticky lg:top-6">
            <div className="border border-border bg-background p-6 space-y-4">
              ...
              <button className="w-full flex items-center justify-center gap-2 bg-primary px-6 py-3 font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-50">
                PROCEED TO CHECKOUT
